...
class AnalyzingScreen extends StatefulWidget {
  ...
  const AnalyzingScreen({Key? key, required this.ingredientName}) : super(key: key);
...
class _AnalyzingScreenState extends State<AnalyzingScreen> {
  ...
  void initState() {
    ...
    super.initState();
    ExtractIngredientInfo(widget.ingredientName).then((value) => Navigator.of(context).push(
      MaterialPageRoute(
        ...
        child: Column(
          ...
          children: [
            ReemKufi_Grey_Center(
                textValue: 'Analyzing Ingredient List', size: displayWidth(context) * 0.075),
